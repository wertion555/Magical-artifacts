package net.mcreator.magicalartifacts.client.model;
...
public class Modelbullet<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("magical_artifacts", "modelbullet"), "main");

...
@Mod("magical_artifacts")
public class MagicalArtifactsMod {
	public static final Logger LOGGER = LogManager.getLogger(MagicalArtifactsMod.class);
	public static final String MODID = "magical_artifacts";

	public MagicalArtifactsMod() {
